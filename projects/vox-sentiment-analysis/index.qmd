...
library(tidyverse)
load("visualizations_worspace.RData")
```
...
![](figures/word_freq/vox_podcasts_top_words.png)
...
![](figures/word_freq/vox_articles_top_words.png)
...
![Vox Podcast Word Cloud](figures/word_freq/vox_podcasts_wordcloud.png)
...
![Vox Article Word Cloud](figures/word_freq/vox_articles_wordcloud.png)
